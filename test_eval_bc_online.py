...
def parse_eval_args():
    ...
    parser.add_argument('--image_path', type=str, default='/home/junyao/test/frame10.jpg',
                        help='location of test frame')
    parser.add_argument('--json_path', type=str, default='/home/junyao/test/frame10.json',
                        help='location of test json')
    parser.add_argument('--mocap_dir', type=str, default='/home/junyao/test',
                        help='location of test mocap dir')
    parser.add_argument('--r3m_embedding_path', type=str, default='/home/junyao/test/frame10_r3m.pkl',
